...
namespace Zero.MongoDB.Domain
{
    ...
    public abstract class ZeroMongoDbContext : IZeroMongoDbContext
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public virtual void InitializeDatabase(IMongoModelSource modelSource, IMongoDatabase database, IMongoClient client, IClientSessionHandle sessionHandle)
        {
